  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://event.bitcoin.design/preview-presidio.jpg' },
  
        { name: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:image', content: 'https://event.bitcoin.design/preview-presidio.jpg' },
